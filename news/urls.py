...
from news.views import (
    ...
    TopicUpdateView,
    TopicDeleteView,
    RedactorDataUpdateView,
    RedactorDeleteView,
    NewspaperCreateView,
    NewspaperUpdateView,
    NewspaperDeleteView,
    NewspaperPublishersUpdateView,
)
...
urlpatterns = [
    ...
    path(
        "newspapers/<int:pk>/update_publishers/",
        NewspaperPublishersUpdateView.as_view(),
        name="update-publishers",
    ),
    path(
        "cars/<int:pk>/delete/", NewspaperDeleteView.as_view(), name="newspaper-delete"
    ),
    ...
    path(
        ...
        RedactorDataUpdateView.as_view(),
